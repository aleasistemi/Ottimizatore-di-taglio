...
import { Database, Plus, Search, Trash2, Edit3, X, Users, Briefcase, CloudSync, Globe, Settings, AlertCircle, CheckCircle2, Eye, Info, ShieldCheck } from 'lucide-react';
          ...
          {activeTab === 'settings' ? (
            <div className="max-w-4xl mx-auto space-y-12 py-10">
               <div className="text-center space-y-4">
                  ...
                  <p className="text-slate-500 max-w-xl mx-auto leading-relaxed">Perfetto per aziende e professionisti che desiderano condividere dati tra più dispositivi in totale sicurezza usando Supabase.</p>
               </div>
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                  ...
                  <div className="space-y-8">
                    <div className="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm space-y-6">
                       ...
                       <div className="space-y-4">
                         {[
                           { t: "Crea il Progetto", d: "Vai su Supabase.com e crea un account gratuito. Crea un nuovo progetto per Alea Sistemi." },
                           { t: "Configura API", d: "Nella sezione Settings > API di Supabase trovi l'URL e la Key (anon public) da incollare qui." },
                           { t: "Sincronizza", d: "Una volta connesso, i profili salvati sul PC verranno caricati nel cloud e viceversa." }
                         ].map((step, i) => (

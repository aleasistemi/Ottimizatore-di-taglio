...
const App: React.FC = () => {
  ...
  const performGlobalSync = async (isManual = false) => {
    // Blocco critico: se abbiamo fatto modifiche locali negli ultimi 30 secondi,
    // NON scarichiamo dati dal cloud per evitare che i dati "vecchi" (non ancora processati dal DB) 
    // sovrascrivano la nostra cache locale aggiornata.
    ...
    try {
      ...
      console.error("Errore sincronizzazione ALEA:", e);
    } finally {
      setIsSyncing(false);
    }
  };
